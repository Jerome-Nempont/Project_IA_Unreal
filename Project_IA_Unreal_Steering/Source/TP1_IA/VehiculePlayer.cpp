...
void AVehiculePlayer::Quit(){UKismetSystemLibrary::QuitGame(GetWorld(), nullptr, EQuitPreference::Quit, true);}
...
void AVehiculePlayer::MoveForward(float Value){Direction = FVector(Value, Direction.Y, Direction.Z);}
void AVehiculePlayer::MoveRight(float Value){Direction = FVector(Direction.X, Value, Direction.Z);}
void AVehiculePlayer::MoveUp(float Value){Direction = FVector(Direction.X, Direction.Y, Value);}